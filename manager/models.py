...
class User(models.Model):
    ...
    facebook = models.CharField(max_length=100, null=True, help_text='carlos.bedoy', null=True)
    twitter = models.CharField(max_length=100, null=True, help_text='@carlos_bedoy', null=True)
